    ...
    <div id="content">
        <table class="table table-striped">
            ...
            ?>
                <tr>
                    <td><?php echo $no ?></td>
                    <td id="td1[<?php echo $data['id'] ?>]" ondblclick="editxml(this.textContent,<?php echo $data['id'] ?>,1)"><?php echo $data['nim'] ?></td>
                    <td id="td2[<?php echo $data['id'] ?>]" ondblclick="editxml(this.textContent,<?php echo $data['id'] ?>,2)"><?php echo $data['nama'] ?></td>
                    <td id="td3[<?php echo $data['id'] ?>]" ondblclick="editxml(this.textContent,<?php echo $data['id'] ?>,3)"><?php echo $data['prodi'] ?></td>
                    <td>
